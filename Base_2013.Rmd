...
params:
  institution: 
    ...
    input: select
    choices: ["International Centre for Theoretical Physics", "Trieste Polytechnic Institute", "CODATA-RDA Summer School", "Elsevier Inc"]        
---
...
a. Ownership of any original data, code, or reports produced as part of this project are owned by `r params$institution` per their institutional intellectual property policy.
